...
public class ConsolaOlimpicos
{
	...
	*/
	...
	private void ejecutarNombreAtletasPorPais()
	{
		System.out.println("\n" + "Atletas de un país" + "\n");

		String atleta = input("Por favor ingrese el nombre del atleta: ");
		String atletas = calculadora.paisAtleta(atleta);
		
		System.out.println("El atleta pertenece al pais " + atletas + "\n");
	}
